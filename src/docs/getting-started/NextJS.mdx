...
Using `@carletonuniversity/rds2` in a Next.js app. Assumes you've completed [Installation](?path=/docs/overview-getting-started-installation--docs).
...
The repo's [`docs/consumers/nextjs.md`](https://github.com/cuweb/rds2/blob/main/docs/consumers/nextjs.md) mirrors this content for GitHub readers.
