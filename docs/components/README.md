...
This document defines the patterns and conventions used for every React component in RDS 2.0. All components follow the same structure to ensure consistency, discoverability, and maintainability.
