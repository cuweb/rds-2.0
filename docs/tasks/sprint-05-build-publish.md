...
- Link the library: `pnpm link ../path/to/rds-2.0`
- Test three import patterns:
  1. `import { Button, Card } from '@carletonuniversity/rds-2.0'` — JS components
  2. `import '@carletonuniversity/rds-2.0/styles'` — global CSS
...
- Verify the package appears on npmjs.com at `@carletonuniversity/rds-2.0`
- Verify the package can be installed in a fresh project: `pnpm add @carletonuniversity/rds-2.0`
