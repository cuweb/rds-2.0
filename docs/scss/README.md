...
This document explains how the SCSS layer of RDS 2.0 is organized, how files relate to each other, and how consumers receive styles.
...
RDS 2.0 uses the modern Sass `@use` and `@forward` system (not the deprecated `@import`).
