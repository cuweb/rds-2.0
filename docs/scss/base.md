...
Base styles establish the global CSS foundation that every page built with RDS 2.0 inherits. They are defined in `src/base/` and **do produce CSS output** — unlike tokens and mixins, these files generate actual rules.
